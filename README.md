...
In theory, this kata implementation should be as simple as possible, but in this project besides applying Outside-In TDD I also want to show a realistic approach, showing how to apply functional programming, domain-driven design and hexagonal architecture to create a "real world" application.
